...
filename = 'C:/Users/Bruker/4150COMP_PHY/project4/4c/final/prj4c_temp1_L20_allup11_mcs25000_plot.txt'
filename2 = 'C:/Users/Bruker/4150COMP_PHY/project4/4c/final/prj4c_temp24_L20_allup_mc25000_plot.txt'
...
with open(filename3) as f3:
    ...
    plt.title(r" MC =25000, allup spin")
    plt.grid()
    plt.savefig("allup_acept2.png")
    plt.show()
    #axes=plt.gca()
    #axes.set_ylim(0,3)
    #plt.ylim = (0, 3)
