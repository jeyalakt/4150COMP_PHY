...
filename = 'C:/Users/Bruker/4150COMP_PHY/project3/final results/MC all.txt'
# print(files)
# i=111
...
with open(filename) as f:
    ...
    plt.xlabel(r"N")
    plt.ylabel(r" realtive error")
    plt.title(r" plot of MC -relative error")
    plt.grid()
