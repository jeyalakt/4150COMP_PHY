...
outf = open('prj5e_jupeff_10.txt', 'w+')
outf.write(" x\t\ty\n")
outf.close()
...
#m_earth=6e24 # in  kg
#m_jupiter=2e27
m_jupiter=2e4 #if m_sun=1 # 2e4 when 10 times
...
for i in range(N-1):
    ...
    # wrong A_x, A_y, r = Acc_Grav_earth_jup1(x[i + 1], y[i + 1])
    ...
    outf = open('prj5e_jupeff_10.txt', 'a')
