...
filename = 'C:/Users/Bruker/4150COMP_PHY/prj5/prj5a_vv1000_n10_2,5pi.txt'
filename2 = 'C:/Users/Bruker/4150COMP_PHY/prj5/prj5a_vv1000_n10_2,6pi.txt'
filename3 = 'C:/Users/Bruker/4150COMP_PHY/prj5/prj5a_vv1000_n10_2,7pi.txt'
filename4 = 'C:/Users/Bruker/4150COMP_PHY/prj5/prj5a_vv1000_n10_2,8pi.txt'
...
with open(filename) as f:
    ...
    plt.figure(1)
    plt.plot(x,y, 'b-', linewidth=2.0, label='2.5*pi')
    #plt.hist(y)
...
with open(filename2) as f2:
    ...
    plt.plot(x2, y2, 'g-', linewidth=2.0, label='2.6*pi')
...
plt.grid()
plt.savefig("VV_earthescapevelocitylNall.png")
plt.show()
