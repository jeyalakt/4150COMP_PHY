...
def voice_input():
    ...
    try:
        a2t = r.recognize_sphinx(audio,
                                 keyword_entries=[('forward', 1.0), ('backward', 1.0), ('left', 1.0), ('right', 1.0),
                                                  ('stop', 1.0), ('find line', 0.95), ('follow', 1), ('lights on', 1),
                                                  ('lights off', 1)])
...
def loop():  # GUI
    ...
    while True:
        ...
        BtnOCV = tk.Button(root, width=15, text='OpenCV', fg=color_text, bg=color_btn, relief='ridge',
                           command=call_opencv)
        ...
        BtnSR3 = tk.Button(root, width=15, text='Sphinx SR', fg=color_text, bg=color_btn, relief='ridge',
                           command=call_SR3)
        ...
        l_inter = tk.Label(root, width=45,
